...
О том, как делаются ветки и куда что добавлять:
- в мастере лежит последняя проверенная сборка. Её трогаем очень редко.
- в девелопе лежит разработка основной функциональности. 
- в "модуль" лежит разработка этого модуля.
При слиянии модуль сливается с тем же модулем, девелоп - с девелопом, обкатанный и завершённый (хотя бы пока) модуль - с девелопом, доведённый до значимого уровня девелоп - с мастером.
